...
(function () {
    ...
    URL = window.UEDITOR_HOME_URL||"/SUV/web//ueditor/";//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[["fullscreen","undo","redo","searchreplace","bold","forecolor","fontfamily","fontsize","imagenone","imageleft","imageright","imagecenter","link","unlink","insertorderedlist","insertunorderedlist","source","highlightcode","snapscreen","insertimage","scrawl","attachment","preview","inserttable","deletetable","mergeright","mergedown","splittorows","splittocols","splittocells","mergecells","insertcol","insertrow","deletecol","deleterow","insertparagraphbeforetable"]]
    ...
    //,lang:'zh-cn'
        ...
        ,initialFrameWidth:786  //初始化编辑器宽度,默认1000
